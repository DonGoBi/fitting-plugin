...
const UI_STYLES = `
    ...
    button { 
        cursor: pointer; background: #333; color: white; border: none; padding: 8px 2px; 
    ...
    #brush-guide { 
        position: fixed; border: 2px solid #00d4ff; border-radius: 50%; 
        pointer-events: none; display: none; z-index: 2147483647; 
        transform: translate(-50%, -50%); background: rgba(0, 212, 255, 0.2); 
    }
`;